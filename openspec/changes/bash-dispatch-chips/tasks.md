...
- [ ] 1.1 Update `ctx.ui.notify` patch in `packages/extension/src/bridge.ts`
...
- [ ] 1.2 Add `packages/extension/src/__tests__/bridge-notify-opts.test.ts`
...
- [ ] 2.1 Add to `packages/dashboard-plugin-runtime/src/index.ts`:
...
- [ ] 2.2 Add `packages/dashboard-plugin-runtime/src/__tests__/interactive-renderer-registration.test.ts`
...
- [ ] 3.1 Create `packages/pi-dev-worktrees-plugin/src/client/BashDispatchRenderer.tsx`
...
- [ ] 3.2 Register in `packages/pi-dev-worktrees-plugin/src/client/index.tsx`:
...
- [ ] 3.3 Add `packages/pi-dev-worktrees-plugin/src/client/__tests__/BashDispatchRenderer.test.tsx`
